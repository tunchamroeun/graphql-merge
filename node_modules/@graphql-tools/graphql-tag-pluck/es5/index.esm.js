...
function generateConfig(filePath, code, _options) {
    ...
    switch (fileExt) {
        ...
        case '.js':
            plugins.push.apply(plugins, __spread(['jsx'], dynamicFlowPlugins));
            break;
        case '.jsx':
            plugins.push.apply(plugins, __spread(['jsx'], dynamicFlowPlugins));
            break;
        case '.flow.js':
            plugins.push.apply(plugins, __spread(['jsx'], flowPlugins));
            break;
        case '.flow.jsx':
            plugins.push.apply(plugins, __spread(['jsx'], flowPlugins));
            break;
...
const createVisitor = (function (code, out, options) {
    ...
    var _a = __assign(__assign({}, defaults), options), modules = _a.modules, globalGqlIdentifierName = _a.globalGqlIdentifierName, gqlMagicComment = _a.gqlMagicComment;
...
function parseWithVue(vueTemplateCompiler, fileData) {
    var parsed = vueTemplateCompiler.parseComponent(fileData);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, import('vue-template-compiler')];
                case 1:
                    // tslint:disable-next-line: no-implicit-dependencies
